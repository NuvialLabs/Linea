...
const SignupPlaceholder = () => {
  return (
    <section className="w-[80%] bg-(--secondary-background) rounded-3xl grid justify-center gap-12 sm:gap-0 justify-items-center mt-12">
      ...
      <button className="flex gap-4 items-center sm:w-2/3 bg-(--accent) my-14 sm:mx-0 mx-2 rounded-xl p-2 cursor-pointer hover:bg-(--accent)/90 active:bg-(--accent)/50 transition-all duration-200">
        <Image
          src={Google}
          alt="Google"
